package ec.ed.upse.tiendavirtual.controladores;
...
public class Index {
	...
	@Command
	public void traducirAudio() throws IOException{
		traducir();
	}
	
	//This method captures audio input from a
	  // microphone and saves it in an audio file.
	  private void captureAudioInterno(){
	    try{
	  ...
	  class CaptureThread extends Thread{
		  public void run(){
		    ...
		    try{
		      ...
		      AudioSystem.write(new AudioInputStream(targetDataLine), FLACFileWriter.FLAC, new File("C:/audiopro/hola.flac"));
		 ...
		 /* httpTransport = GoogleNetHttpTransport.newTrustedTransport();
	      ...
	      Credential credential = authorize();*/
			...
			*/
		    ...
		    String newFileName = newPath + "recursosAudios\\hola.flac";
